...
class Trader:
    ...
    def run(self, state: TradingState):
        ...
        if "RAINFOREST_RESIN" in state.order_depths:
            ...
            rainforest_resin_orders = self.rainforest_resin_orders(state.order_depths["RAINFOREST_RESIN"], rainforest_resin_fair_value, rainforest_resin_width, rainforest_resin_position, rainforest_resin_position_limit)
